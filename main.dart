...
class StockPrice {
  ...
  factory StockPrice.fromJson(Map<String, dynamic> json) {
    return StockPrice(
      ...
      json['l'].toDouble(),  // Menggunakan atribut "l" (harga terendah)
    );
  }
}
...
class _StockPriceChartState extends State<StockPriceChart> {
  ...
  Future<void> loadStockPrices() async {
    final response = await http.get(
        Uri.parse(
            'https://api.polygon.io/v2/aggs/ticker/R/range/1/day/2023-01-09/2023-02-09?adjusted=true&sort=asc&limit=120&apiKey=QDtyeHJBcgpV3Lj5MMQ_e5ltCnIUoFiI'));
